...
public class FloatingActionButton extends FrameLayout {
    ...
    public void setContentView(View contentView, LayoutParams contentParams) {
        ...
        if(contentParams == null ){
            ...
            final int margin = getResources().getDimensionPixelSize(com.oguzdev.circularfloatingactionmenu.library.R.dimen.action_button_content_margin);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            int size = context.getResources().getDimensionPixelSize(com.oguzdev.circularfloatingactionmenu.library.R.dimen.action_button_size);
            int margin = context.getResources().getDimensionPixelSize(com.oguzdev.circularfloatingactionmenu.library.R.dimen.action_button_margin);
            LayoutParams layoutParams = new LayoutParams(size, size, Gravity.BOTTOM | Gravity.RIGHT);
            layoutParams.setMargins(margin, margin, margin, margin);
            setLayoutParams(layoutParams);
            setTheme(com.oguzdev.circularfloatingactionmenu.library.FloatingActionButton.THEME_LIGHT);
